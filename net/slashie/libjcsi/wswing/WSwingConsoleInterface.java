...
public class WSwingConsoleInterface implements ConsoleSystemInterface, Runnable, ComponentListener {
    ...
    public static int xdim = 120; //TODO How much places there are on the screen
    public static int ydim = 40; //original 80*25
    ...
    public WSwingConsoleInterface(String windowName, boolean sandboxDeploy) {
        ...
        java.awt.Dimension initialSize = new java.awt.Dimension(1600, 1280); //original 1280*1024
